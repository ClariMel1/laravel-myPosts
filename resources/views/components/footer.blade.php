...
<section class="bg-pink-200 shadow py-4">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div class="flex space-x-4 mb-2">
            <a href="https://github.com/ClariMel1/laravel-myPosts" target="_blank" class="hover:text-[#732255]">
        ...
        <div class="text-center mt-2">
            <p class="text-[#732255] font-semibold text-lg">Grupo Los atomicos</p>
            <p class="text-[#732255] text-sm">Programación web Dinámica</p>
